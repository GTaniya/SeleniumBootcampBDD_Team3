...
public class HomePageStepDefinition  extends WebAPI {
    ...
    public void tearDown(Scenario scenario) {
        if (scenario.isFailed()) {
            ...
            scenario.attach(screenShot, "image/png", "Redfin");  // embed it in the report
        }
    }
    ...
    public void iAmOnTheRedfinPage() throws IOException {
    ...
    public void iEnterInTheSearchBar(String searchText) {
        homePage.searchLocationInSearchBar(searchText);
    ...
    public void iVerifyInSearchBar(String expectedTextValue) {
        homePage.verifyingExpectedText(expectedTextValue);
